# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 18:30:41 2019
...
print("\nPOLYNOMIAL FUNCTION WITH DEGREE 7 -")

SV2 = svm.SVC(kernel="poly", degree=7, gamma= "scale", C=0.001) # Create the svm classifier for polynomial kernel function. 
                                    #gamma= "scale" is used to to avoid FutureWarning Messages in scikit-learn
                                    #C=0.001 is used as a small penalty parameter for the error gives a faster output.

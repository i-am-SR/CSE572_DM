# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 14:15:15 2019
...
train = pd.read_csv("PB3_train.csv", header=None, names=columns) #Reading the training dataset

attributes = ['height', 'age', 'weight']
X_train = train[attributes] # Attributes of the data
y_train = train.gender # Class

test = pd.read_csv("PB3_test.csv", header=None, names=columns) #Reading the test dataset
...
task3 = StringIO()
export_graphviz(dt, out_file=task3,
